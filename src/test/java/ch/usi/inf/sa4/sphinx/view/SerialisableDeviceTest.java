...
public class SerialisableDeviceTest {
    ...
    static Stream<Arguments> argumentsProvider() {
        return Stream.of(
                arguments(101, "testIcon", "testName", "testLabel", new int[10], new int[]{3, 6}, 1.0, 666, 1, true, "url", 20, 23, 43),
                arguments(0, "__testIcon", "testName", "testLabel", new int[1], new int[]{1, 2, 4, 6}, 1.0, 666, 1, true, "URL!!", 0, -10, 4444),
                arguments(984354, "#testIcon", "testName", "testLabel", new int[10000], new int[]{0}, 0.0, 666, 1, true, "Noturl", -20, 2222, -111)
        );
    }
    ...
    void testLongConstructor(Integer id, String icon, String name, String label, int[] switched, int[] switches, double intensity, Integer roomId, int type, boolean on, String url, double quantity, double averageTemp, double targetTemp) {
        serialisableDevice = new SerialisableDevice(id, icon, name, label, switched, switches, intensity, roomId, type, on, url, quantity, averageTemp, targetTemp);
