...
public abstract class Device extends StorableE {
    ...
    @Expose
    @Transient
    protected boolean active; //DO NOT USE ON, IT'S RESERVED IN SQL!!!
    ...
    protected SerialisableDevice serialise() {
        ...
        serialisableDevice.on = this.active;
    ...
    // TODO: when couplingService deletes a coupling, it must call removeObserver active all registered Devices
